<?php
    ...
    /*
        ...
        3. Om användaren har tryckt på submit-knappen btnDeleteSession skall du (kodförslag nedan):
    ...
    */
    if( isset($_POST["btnDeleteSession"])) { //3a

        if( session_status() === PHP_SESSION_ACTIVE) { //Koden innanför if-satsen tar bort sessionkakan på klienten.
            $_SESSION = array(); //3b & 3c
        ...
        header("location: startsesssion.php"); //3d
        exit(); //3e
    }
